...
try:
    ...
    print("")
    print("This demo requires xarm_ros2. Install it with ONE of:")
    print("")
    print("  Option A  (build from source – recommended):")
    print("    cd <your_workspace>/src")
    print("    git clone https://github.com/xArm-Developer/xarm_ros2.git")
    print("    cd .. && colcon build --symlink-install")
    print("")
    print("  Option B  (separate workspace):")
    print("    mkdir -p ~/xarm_ws/src && cd ~/xarm_ws/src")
    print("    git clone https://github.com/xArm-Developer/xarm_ros2.git")
    print("    cd ~/xarm_ws && colcon build --symlink-install")
    print("    source ~/xarm_ws/install/setup.bash   # before launching demo")
    print("=" * 70 + "\n")
    sys.exit(1)
